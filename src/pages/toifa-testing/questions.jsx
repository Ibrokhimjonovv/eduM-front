...
const Question = ({
  ...
  return (
    <div className="testing-container">
      <div className="testing-container-inner">
        <div className="current-question-count">
        ...
        </div>
        {
          timeLeft === 0 && (
            <div className="left-loading">
              <p>Vaqt tugadi natijalar taxlil qilinmoqda...</p>
            </div>
          )
        }
          ...
          <div id="flex">
            <>
              {currentQuestionIndex > 0 && (
                <button onClick={handlePreviousQuestion}>Oldingi</button>
              )}
              <p>
              ...
              {currentQuestionIndex < test.questions.length - 1 ? (
                ...
                <button onClick={calculateResults} disabled={res}>
                  {res ? "Taxlil qilinmoqda..." : "Natijani Ko'rish"}
                </button>
